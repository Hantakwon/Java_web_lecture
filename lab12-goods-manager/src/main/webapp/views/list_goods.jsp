...
<%
	...
	if (goodsList != null) {
%>		
		<form id='list_form' action='register_form' method='GET'>
			<table align="center">
				<thead>
...
%>
					<tr>
						...
						<td>
							<a href='update_form?code=<%= goods.getCode() %>'>수정</a>
							<a href='#' onclick='confirmAndDelete("<%= goods.getCode() %>","<%= goods.getTitle() %>");'>삭제</a>
						</td>
					</tr>
<%			
			}
