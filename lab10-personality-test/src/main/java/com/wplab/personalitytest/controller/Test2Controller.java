...
@WebServlet(name = "Test2Controller", value = {"/test2"})
public class Test2Controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		replyStore.put("question1", Integer.parseInt((String)request.getAttribute("question1")));
		replyStore.put("question2", Integer.parseInt((String)request.getAttribute("question2")));
