...
public class MemberInfo {
	...
	public String getInotice() {
		return inotice;
	}

	public void setInotice(String inotice) {
	...
	public String toString() {
		return "Memberinfo [name=" + name + ", id=" + id + ", passwd=" + passwd + ", gender=" + gender + ", inotice="
				+ inotice + ", cnotice=" + cnotice + ", dnotice=" + dnotice + ", job=" + job + "]";
	}
